 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | SUPER  | CAPS   | ALT    | NUM    | SPACE  | <      | .      | >      | SPACE  | FUN    | '      | ¡      | \      | SYS    |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

  [_QWERTY] = LAYOUT_ortho_5x15( /* QWERTY */
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_HOME, KC_DEL , KC_END,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LPRN, KC_SCLN, KC_RPRN, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT,
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LCBR, KC_COLN, KC_RCBR, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_COMM, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_CAPS, KC_LALT,  NUM,    KC_SPC,  KC_LABK, KC_DOT , KC_RABK, KC_SPC,  FUN ,    SYS,     KC_DOWN, KC_UP,   SYSTEM
  ),
 ...
 */
  ...
  [_NUM] = LAYOUT_ortho_5x15( /* LOWER */
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, _______, _______,
 ...
 */
  ...
  [_FUN] = LAYOUT_ortho_5x15( /* QWERTY */
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, _______, KC_F6,   KC_F7,   KC_F8,    KC_F9,   KC_F10,  KC_SLEP,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_F11,  KC_F12,  _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_MENU, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
  )
};
